...
function songKey(e){ return (e.title+'|'+e.artist).toLowerCase().trim(); }
...
function fv(n){n=Number(n);if(n>=10000)return(n/10000).toFixed(1)+'万';return n.toLocaleString('ja-JP');}
